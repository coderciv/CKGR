...
def parse_args(args=None):
    ...
    parser.add_argument("--cuda_id", type=str, default="cuda:1",
    ...
    parser.add_argument("--inverse_relation", type=bool, default=True,
                        help="Include inverse relation graph")

    parser.add_argument("--dynamic_sim_graph", type=bool, default=False,
    ...
    parser.add_argument("--keep_true_adjacency", type=float, default=0.0,
                        help="How many true edges are preserved")
    ...
    file_handler = logging.FileHandler(str(cur_time) + 'train.log')
    ...
    for x in vars(args):
        logger.info("{} : {}".format(x,vars(args)[x]))
